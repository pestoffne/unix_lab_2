...
$(OUT)/lab: $(OUT)/main.o $(OUT)/child.o $(OUT)/std.o $(OUT)/kill.o
	gcc -o $(OUT)/lab $(OUT)/main.o $(OUT)/child.o $(OUT)/std.o $(OUT)/kill.o

$(OUT)/main.o: $(SRC)/main.c $(INC)/child.h $(INC)/std.h $(INC)/kill.h
